    ...
    <>
     <div className='weather-form max-x-wd mx-auto mt-10 p-4 border rounded shadow'>
        <form onSubmit={fetchWeather}>
            <input type="text" value={city} onChange={(e)=>setCity(e.target.value)} placeholder='Enter City Name' className='border px-2 py-1 mr-2'/>
            <button type='submit' className='bg-blue-600 text-white px-4 py-1 rounded'>Get Weather</button>
        ...
        {weather &&(
            <div className='mt-4'>
                ...
                <p >{weather.weather[0].min}-{weather.weather[0].description}</p>
